            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 shadow-lg h-full">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="p-3 bg-blue-100 dark:bg-blue-900/50 rounded-full text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800/50 transition-colors"
                  aria-label="LinkedIn"
                >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-white focus:border-blue-600 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-600/50 dark:focus:ring-blue-400/50 outline-none transition-colors"
                  />
                </div>
                <div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-white focus:border-blue-600 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-600/50 dark:focus:ring-blue-400/50 outline-none transition-colors resize-none"
                ></textarea>
              </div>
